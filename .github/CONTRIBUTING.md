# Contributing to footrulr

This outlines how to propose a change to __footrulr__. For more detailed info about contributing to packages please see the [**development contributing guide of the tidyverse**](https://rstd.io/tidy-contrib) (wherever you read __tidyverse__ think __footrulr__).
...
See tidyverse [development contributing guide](https://rstd.io/tidy-contrib) for further details (wherever you read __tidyverse__ think __footrulr__).
